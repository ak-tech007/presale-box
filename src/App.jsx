...
function App() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-blue-500 p-6">
      {/* Main Container */}
      <div className="w-full max-w-md rounded-3xl border-4 border-gray-800 bg-purple-900 p-6 text-center text-white shadow-xl">
        ...
        <div className="relative mb-6 flex space-x-4 items-center">
          ...
          {isModalOpen && (
            <div className="absolute top-full w-full" ref={modalRef}>
              <PaymentModal onSelectToken={handleSelectToken} />
            </div>
          )}
